...
15%</span>)
  ...
  `,img:`${e}/assets/act2/bosses/the-collector.webp`,moves:`
    flowchart-elk TB
  ...
  `,name:"The Collector",slug:"the-collector"})),Is=()=>t(Cs),Bt=s(()=>({effect:`${n.v>=3?7:6} x N Damage. N = 2 + ${n.v>=18?"Multi/Single Stabs":"Multi-Stabs"} used`,intent:`${e}/assets/intents/3.png`,name:"Multi-Stab"})),Dt=s(()=>({effect:`${n.v>=3?24:21} Damage.`,intent:`${e}/assets/intents/5.png`,name:"Single Stab"})),Ls=s(()=>({flowchart:`
    flowchart-elk TB
      A(*${t(Bt).name}*
...
15%</span>)
  ...
  `,img:`${e}/assets/act2/elites/gremlin-leader.webp`,moves:`
    flowchart-elk TB
...
50%</span>)
  ...
  `,img:`${e}/assets/act3/elites/nemesis.webp`,moves:`
    flowchart-elk TB
  ...
  `,img:`${e}/assets/act3/elites/reptomancer.webp`,moves:`
    flowchart-elk TB
  ...
  `,name:"Reptomancer",slug:"reptomancer"})),$a=()=>t(ga),it=s(()=>({effect:`${n.v>=2?"D + 2":"D"} Damage. D is chosen between 7 and 11 at the beginning of the battle.`,intent:`${e}/assets/intents/2.png`,name:"Nip"})),Rt=s(()=>({effect:`${n.v>=2?9:8} x 2 Damage.`,intent:`${e}/assets/intents/4.png`,name:"Chomp"})),ot=s(()=>({effect:`12 Block.${n.v>=17?" 2 Strength.":""}`,intent:`${e}/assets/intents/${n.v>=17?"defendBuff":"defend"}.png`,name:"Harden"})),wn={effect:"Revives with 50% HP.",intent:`${e}/assets/intents/buff1.png`,name:"Reincarnate"},jn={effect:"Nothing.",intent:`${e}/assets/intents/unknown.png`,name:"Regrow"},ma=s(()=>({flowchart:`
    flowchart-elk LR
      ...
      Middle~~~Outer~~~E
  `,img:`${e}/assets/act3/monsters/darkling.webp`,moves:`
    flowchart-elk TB
  ...
  `,name:"Darkling",slug:"darkling"})),pa=()=>t(ma),kn=s(()=>({effect:`${n.v>=2?11:10} Damage. 1 Burn into draw. 1 Burn into discard.`,intent:`${e}/assets/intents/attackDebuff.png`,name:"Laser"})),vn=s(()=>({effect:`${n.v>=2?16:15} Damage.`,intent:`${e}/assets/intents/4.png`,name:"Claw"})),ba=s(()=>({flowchart:`
    flowchart-elk TB
